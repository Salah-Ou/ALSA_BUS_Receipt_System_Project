...
void ALSA::student_card(){
    ...
    if (new_student.etablish == "Primaire" || new_student.etablish == "PRIMAIRE" || new_student.etablish == "primaire"){
        gotoxy(18,9);
        cout << "\033[1;37mEstablishment : E 20 Aout / E 2 Mars / ANNEXE E ENNAHDA / E 18 NOVEMBRE / E ADRAR / E AGDAL / another " ;
        gotoxy(18,11);
        cout << "   \033[1;31m(*) \033[1;34mSelcet option : " ;
        cin.ignore();
        ...
        gotoxy(18,9);
        cout << "\033[1;37mEstablishment : C AL AMANE / C ALLAL EL FASSI / C 20 AOUT / C AL FIRDAOUS / C ATLAS / C AL NAHDA / Another Specialization " ;
        gotoxy(18,11);
        cout << "   \033[1;31m(*) \033[1;34mSelcet option : " ;
        cin.ignore();
        getline(cin,new_student.etablish);
        ...
        gotoxy(18,9);
        cout << "\033[1;37mEstablishment : L AL FADILA / L AL QODS / L AL KHAWARIZMI / L IBN SINA / L AJDIR / L 06 NOVEMEBRE / Another Specialization " ;
        gotoxy(18,11);
        cout << "   \033[1;31m(*) \033[1;34mSelcet option : " ;
        cin.ignore();
        getline(cin,new_student.etablish);
        ...
        gotoxy(18,9);
        cout << "\033[1;37mEstablishment : ENAA / ENSA / FS / ENCG / EST / BTS / FS Lettres / FS Economie / Another Establishment / CMC " ;
        gotoxy(18,11);
        cout << "   \033[1;31m(*) \033[1;34mSelcet option : " ;
        cin.ignore();
        getline(cin,new_student.etablish);
        ...
        gotoxy(18,9);
        cout << "\033[1;37mEstablishment : CMC / CENTRE ASSISTANC ET INSIRTION TILILA / ISTA AGADIR / ISTA INZGAN / ISTA ASSAKA / Another Establishment " ;
        gotoxy(18,11);
        cout << "   \033[1;31m(*) \033[1;34mSelcet option : " ;
        cin.ignore();
        getline(cin,new_student.etablish);
    ...
    gotoxy(18,21);
    cout << "\033[1;31m(*) \033[1;37m Date of Birth (DD/MM/YYYY) : " ;
    ...
    if (new_student.date == "today" || new_student.date == "TODAY"){
        ...
        gotoxy(18,37);
        cout << "\033[1;31m(*) \033[1;37m Schedule : \033[1;30m Open at this time from 8:30 am to 6:30 pm daily, otherwise closed on Sunday all day.\033[1;37m" ;
    }
    ...
    if (students.empty()){
        ...
        for(int i = 0 ; i < students.size() ; i++){
            if (name == students[i].name && cni == students[i].CNI){
                ...
                gotoxy(18,11);
                cout << "\033[1;31m(*) \033[1;37mCard Start Date (DD/MM/YYYY) : " ;
                cin >> new_shop.card_start_date ;
                gotoxy(18,13);
                cout << "\033[1;31m(*) \033[1;37mCard End Date (DD/MM/YYYY) : " ;
...
int main(){
    ...
    while(true){
        ...
        cout << "\033[1;37m Current Time's : \033[1;36m" << current_time << "\033[1;37m" ;  
        gotoxy(18,1);
        cout << "\033[1;7;34m ALSA \033[0m\033[3;7;34mMOROCCO \033[0m " ;
        gotoxy(18,2);
